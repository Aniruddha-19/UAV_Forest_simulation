...
def get_train_transform():
    return A.Compose([
        ...
        #A.RGBShift(p=0.5),
        #add additional transforms to artificially add scaled down objects: examples include, BBoxSafeRandomCrop, CropAndPad, RandomScale
        A.CropAndPad(p=0.3, percent=(-0.2, 0.2), pad_mode=0, keep_size=True),
        A.BBoxSafeRandomCrop(p=0.5, erosion_rate=0.2),
        ToTensorV2(p=1.0),
    ], bbox_params={
        'format': 'pascal_voc',
        'label_fields': ['labels']
