...
class CustomDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        for member in root.findall('object'):
            ...
            # If classifier is not within classes, mark as 'Others'
            if member.find('name').text not in self.classes:
                labels.append(self.classes.index('Others'))
            else:
        ...
        # Keep labels as a plain list for albumentations, convert to tensor after transforms.
        labels_list = labels
        ...
        # Filter out degenerate boxes (zero or negative width/height) that may
        # result from augmentation clipping boxes to image boundaries.
